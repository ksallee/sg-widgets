...
<Install item="entity-tree" />

<Demo name="entity-tree" title="Entity Tree: a project seeded open to one shot, with checkboxes, a search, a thumbnail variant, a row whose thumbnail field is empty, and the three sizes beside a button" />
