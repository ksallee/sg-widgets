...
| `siteUrl` | `string` | — | The site the stock sprite is served from, and the site a linked row is addressed on. |
...
| `context` | `SgContext` | — | Supplies the site url and reads the hover card's fields. |
