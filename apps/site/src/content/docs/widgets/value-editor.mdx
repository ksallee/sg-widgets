...
```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/value-editor.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/value-editor.json
```
