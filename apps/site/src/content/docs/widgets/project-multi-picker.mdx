...
Single and multi: [ProjectPicker](/widgets/project-picker/) takes one project.

## Install

```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/project-multi-picker.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/project-multi-picker.json
```
...
|---|---|---|---|
| `value` | `EntityRef[]` | `[]` | The chosen projects, in the order they were ticked. Two-way in Svelte. |
