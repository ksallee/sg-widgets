...
```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/match-text.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/match-text.json
```
