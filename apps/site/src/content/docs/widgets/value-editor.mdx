...
<Props name="value-editor" />

## Events

None. The session emits; the box draws.

## Slots

`children` is the control the box is drawn around. `errorMessage` draws the line under it
in place of the default one.

## Keyboard

<Props name="value-editor" kind="keyboard" />
