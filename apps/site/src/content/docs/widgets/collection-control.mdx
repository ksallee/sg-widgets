...
```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/collection-control.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/collection-control.json
```
