...
```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/list-editor.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/list-editor.json
```

<Demo name="list-editor" title="ListEditor: valid values, labels, and a project's hidden values removed" />
