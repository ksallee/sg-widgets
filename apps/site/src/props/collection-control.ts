...
export default {
  ...
  props: [
    { name: 'source', type: '`EntitySource`', default: '—', meaning: 'The rows, the filter, the sort and the page behind them.' },
    { name: 'paging', type: '`\'pages\' | \'more\' | \'scroll\'`', default: '—', meaning: 'How the set is walked: a page number, a load-more row, or the scroller. The source follows it.' },
