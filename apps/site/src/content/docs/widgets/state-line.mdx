...
```sh
pnpm dlx shadcn@latest add https://sg-widgets.dev/r/react/state-line.json
pnpm dlx shadcn-svelte@latest add https://sg-widgets.dev/r/svelte/state-line.json
```
