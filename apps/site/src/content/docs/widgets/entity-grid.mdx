...
| `context` | `SgContext` | required | Every tile reads its schema, its statuses and its links through it. |
...
| `onselect` / `onSelect` | `EntityRow` | A tile was activated, by click or by Enter. |
