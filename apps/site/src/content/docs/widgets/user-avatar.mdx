...
| `apiUser` | `boolean` | `false` | Adds a badge marking a script account, and names it in the tooltip. |
...
The root carries an inactive data attribute when the user is dimmed.
