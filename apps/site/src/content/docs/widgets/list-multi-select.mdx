...
value already held that is outside that set keeps showing in the trigger.

The trigger reads the chosen labels joined by commas, with the count in a badge at its end.
