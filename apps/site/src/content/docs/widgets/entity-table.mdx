...
A double-click on an editable cell opens the editor too. A press inside a popup the editor opened —
a calendar, a status list, a picker's results — leaves the cell open. A header drags onto another to
reorder, and its right edge drags to resize.
